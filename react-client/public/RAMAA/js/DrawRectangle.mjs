...
class DrawRectangle extends Draw {
  ...
  constructor(settings, stateObj) {
    //-// console.log('%% DrawRectangle.mjs :: DrawRectangle CONSTRUCTOR EXECUTED')
    ...
    this.svgDom = document.createElementNS(this.nsSvg, 'rect')
    ...
    this.svgDom.setAttribute("width", settings.width)
    this.svgDom.setAttribute("height", settings.height)
    this.svgDom.setAttribute("fill", settings.fill)
    this.svgDom.setAttribute("rx", "10px")
    this.svgDom.setAttribute("id", this.groupId + '_rect')
  ...
  setDataStore() {
    this.dataStore = {
      ...
      x: parseInt(this.svgDom.getAttribute('x')),
      y: parseInt(this.svgDom.getAttribute('y')),
      width: parseInt(this.svgDom.getAttribute('width')),
      height: parseInt(this.svgDom.getAttribute('height')),
  ...
  afterload(settings) {
    ...
    this.svgDom.setAttribute("id", settings.id + '_rect')
    this.svgDom.setAttribute("x", settings.x)
    this.svgDom.setAttribute("y", settings.y)
    this.svgDom.setAttribute("width", settings.width)
    this.svgDom.setAttribute("height", settings.height)
    this.svgDom.setAttribute("fill", settings.fill)
  ...
  duplicateSetting(prevObj) {
    ...
    //   let newKeyName = this.groupId + '_' + tmName.split('_')[1]
    //   this.timelines[newKeyName] = prevObj.timelines[tmName]
    // }

    // ------------------------------------
    // CREATE RECTANGLE SHAPE
    this.svgDom.setAttribute("x", parseInt(prevObj.svgDom.getAttribute("x")))
    this.svgDom.setAttribute("y", parseInt(prevObj.svgDom.getAttribute("y")))
    this.svgDom.setAttribute("width", parseInt(prevObj.svgDom.getAttribute("width")))
    this.svgDom.setAttribute("height", parseInt(prevObj.svgDom.getAttribute("height")))
    this.svgDom.setAttribute("fill", prevObj.svgDom.getAttribute("fill"))
    this.svgDom.setAttribute("rx", prevObj.svgDom.getAttribute("rx"))
