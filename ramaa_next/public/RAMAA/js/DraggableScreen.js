...
class DraggableScreen {
  ...
  constructor() {
    //-// console.log('%% DraggableScreen.js :: DraggableScreen CONSTRUCTOR EXECUTED')
    this.dragObj
    this.screenDrag
  ...
  setScreen(settings) {
    ...
    this.screenDragEvHnd_md = (ev) => {
      //-// console.log('%% DraggableScreen.js :: SCREEN MOUSE DOWN !!!')
    ...
    this.screenDragEvHnd_mv = (ev) => {
      //console.log('%% DraggableScreen.js :: SCREEN MOUSE MOVING !!!')
      this.xPos = ev.clientX - this.trim.left
      this.yPos = ev.clientY - this.trim.down

      //console.log(`%% DraggableScreen.js :: MOUSE X POSITION ::  ${this.xPos}  Y POSITION ::  ${this.yPos}`)
    ...
    this.screenDragEvHnd_mu = (ev) => {
      //-// console.log('%% DraggableScreen.js :: SCREEN MOUSE UP !!!')
