...
class SourceManager {
  ...
  constructor() {
    //-// console.log('%% SourceManager.js :: SourceManager CONSTRUCTOR EXECUTED')
  }


  loadFromJson(data, stateObj) {
    //-// console.log("%% SourceManager.js :: MENU - saveToJson BUTTON CLICKED")

    // 1. OPEN DIALOG BOX TO SELECT FILE
    // DONE AT StateEditting.js : 239
