...
import { SlotMatrix }       from "./SlotMatrix.js"



// DRAW SVG OBJECT : RECTANGLE SHAPE

class DrawSlotMatrix extends Draw {

  constructor(settings, stateObj) {
    //-// console.log('%% DrawSlotMatrix.js :: DrawSlotMatrix CONSTRUCTOR EXECUTED')
