...
import { AttribManager }        from "./AttribManager.js"
import { ModalManager }         from "./ModalManager.js"
import { SliderDraggable }      from "./SliderDraggable.js"
...
class StateEditting extends State {
  ...
  constructor(name) {
    //-// console.log('%% StateEditting.js :: StateEditting CONSTRUCTOR EXECUTED')
    super(name)
  ...
  initialize(SCENEINDEX, SHIFTKEYPRESSED, SELECTEDLIST) {
    ...
    this.loadPrevScene = (ev) => {
      ...
      this.SCENEINDEX = prevFile.index
    ...
    this.loadNextScene = (ev) => {
      ...
      this.SCENEINDEX = nextFile.index
    ...
    this.sourceBtnQuickSaveClick = ( event ) => {
      //-// console.log("%% StateEditting.js :: MENU - sourceBtnQuickSaveClick BUTTON CLICKED")
    }
    ...
    this.sourceBtnExportJsonClick = ( event ) => {
      //-// console.log("%% StateEditting.js :: MENU - sourceBtnExportJsonClick BUTTON CLICKED")
    ...
    this.sourceBtnExportSvgClick = ( event ) => {
      //-// console.log("%% StateEditting.js :: MENU - sourceBtnExportSvgClick BUTTON CLICKED")
    }
    ...
    this.createBtnTextAreaClick = (event) => {
      //-// console.log("%% StateEditting.js :: MENU - createBtnTextAreaClick BUTTON CLICKED")
    ...
    this.createBtnArrowClick = (event) => {
      //-// console.log("%% StateEditting.js :: MENU - createBtnArrowClick BUTTON CLICKED")
    ...
    this.createBtnRectClick = (event) => {
      //-// console.log("%% StateEditting.js :: MENU - createBtnRectClick BUTTON CLICKED")
      //event.stopPropagation()
    ...
    this.createBtnBallClick = (event) => {
      //-// console.log("%% StateEditting.js :: MENU - createBtnBallClick BUTTON CLICKED")
      //event.stopPropagation()
    ...
    this.aboutBtnConfigClick = ( event ) => {
      //-// console.log("%% StateEditting.js :: MENU - aboutBtnConfigClick BUTTON CLICKED")
    }


    this.aboutBtnCollabClick = (event) => {
      //-// console.log("%% StateEditting.js :: MENU - aboutBtnCollabClick BUTTON CLICKED")
    ...
    this.aboutBtnClick = (event) => {
      ...
      //-// console.log("%% StateEditting.js :: MENU - ABOUT BUTTON CLICKED")
    ...
    this.sourceBtnClick = (event) => {
      //-// console.log("%% StateEditting.js :: MENU - sourceBtnClick BUTTON CLICKED")
    }
  ...
  onEnter(SCENEINDEX, SHIFTKEYPRESSED, SELECTEDLIST) {
    //-// console.log(`%%  StateEditting.js : onEnter FUNCTION OF ==  ${this.name}  ==  EXECUTED`)
    this.initialize(SCENEINDEX, SHIFTKEYPRESSED, SELECTEDLIST)
  }
