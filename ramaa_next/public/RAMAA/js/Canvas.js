...
class Canvas {
  ...
  constructor(settings) {
    //-// console.log('%% Canvas.js :: Canvas CONSTRUCTOR EXECUTED')
    ...
    this.windowResize = () => {
      // console.log("%% Canvas.js :: BROWSER RESIZED canvas_dom RESIZED EITHER")
  ...
  zoomIn() {
    //-// console.log('%% Canvas.js :: zoomIn() FUNCTION EXECUTED')
